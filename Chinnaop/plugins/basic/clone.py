...
from Chinnaop.helper.basic import edit_or_reply, get_text, get_user

from Chinnaop.plugins.help import *

OWNER = os.environ.get("OWNER", "G D N B H A R A T H")
BIO = os.environ.get("BIO", "ɪ ᴀᴍ ᴘᴀʀᴛ ᴏғ ᴀʟᴘʜᴀ @aboutchinnalu")
